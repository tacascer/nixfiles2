...
When agents return:
- Read each explicit final status/report before relying on any child work
- Read each summary
...
Return: Explicit final status/report plus a summary of what you found and what you fixed.
```
...
After agents return:
1. **Read explicit final status/report** - Do not infer success from quiet logs or diffs
